      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            ...
            <li><a href="raw_materials.php"><i class="fas fa-boxes"></i>Materials</a></li>
            <li><a href="raw_stock_logs.php"><i class="fas fa-clipboard-list"></i>Raw Logs</a></li>
          </div>
        </ul>
      </li>
...
<script>
  ...
  function updateNotifications() {
    ...
    .then(([memberData, notifData]) => {
      ...
      const notificationDot = notificationBell ? notificationBell.querySelector('span') : null;
